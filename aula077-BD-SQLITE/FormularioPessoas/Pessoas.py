...
class ControlePessoas:
    ...
    def criar_componentes(self):
        ...
        # evento que ao clicar direciona o item clicado, evento ONclick
    ...
    def selecionar_item(self, event):
        ...
        self.txt_codigo.insert(0, dados[0]) #cod

        self.txt_nome.delete(0, END)
        self.txt_nome.insert(0, dados[1]) #nome

        self.txt_idade.delete(0, END)
        self.txt_idade.insert(0, dados[2]) #sexo

        self.var.set(dados[3])
        self.cmb_cidade.set(dados[4]) #idade
